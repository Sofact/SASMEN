    ...
    .H3t
{
 color: #3366CC;
  ...
  <div class="row">
    <div class="col">
      <h3 class="H3t">Resumen Financiero</h3>
		...
		<br>
			...
			<div class="container">
			  <div class="row">
			    ...
			    <div class="w-150"></div>
			    <div class="col"><strong>Valor total del convenio:</strong></div>
			    <div class="col" id="resumenValor" name="resumenValor"> </div>
			    <div class="w-150"></div>
			    <div class="col"><strong>Valor ejecución del convenio:</strong></div>
			    <div class="col" id="resumenValor" name="resumenValor"> </div>
			     <div class="w-150"></div>
			    <div class="col"><strong>Saldo por ejecutar:</strong></div>
			    <div class="col" id="resumenValor" name="resumenValor"> </div>
			  </div>
			</div>
		</div>
