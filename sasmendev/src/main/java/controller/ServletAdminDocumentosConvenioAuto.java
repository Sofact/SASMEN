...
/**
 * Servlet implementation class ServletAdminDocumentosConvenioAuto
 */
@WebServlet("/ServletAdminDocumentosConvenioAuto")
public class ServletAdminDocumentosConvenioAuto extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ServletAdminDocumentosConvenioAuto() {
        super();
        ...
        JSONParser parser = new JSONParser();  
			...
			try {
				...
				for (int i = 0; i < jsonarr.size(); i++) {
				      ...
				      convenioTipoDoc.setConvId(convenioId); 
