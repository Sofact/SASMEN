...
/**
 * Servlet implementation class ServletCargaConvenioFiltrado
 */
@WebServlet("/ServletCargaConvenioFiltrado")
public class ServletCargaConvenioFiltrado extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ServletCargaConvenioFiltrado() {
        super();
