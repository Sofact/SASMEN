...
/**
 * Servlet implementation class ServletCalculaAlarmas
 */
@WebServlet("/ServletCalculaAlarmas")
public class ServletCalculaAlarmas extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ServletCalculaAlarmas() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		List<SgdConvenioTipoDocumento> cotd = gd.getConvenioTipoDocumento(val);
